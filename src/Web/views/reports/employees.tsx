import {Grid, GridColumn, GridFilterChangeEvent, GridNoRecords, GridToolbar} from '@progress/kendo-react-grid';
...
const Employees = () => {
    ...
    useEffect(() => {
        ApiService.getAllEmployeesCompany().then((res) => {
            // only here
        ...
        <Fragment>
            <ExcelExport data={EmployeesDataFetch} ref={_export} dir='rtl'>
                ...
                >
                    ...
                    <GridColumn width="170px" field="company" title="نام شرکت"/>
                    <GridColumn width="200px" field="address" title="آدرس"/>
                    <GridColumn width="200px" field="relativesCount" title="تعداد اعضای خانواده"/>
